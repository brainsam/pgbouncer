...
RUN pip install docutils \
  && wget https://github.com/pgbouncer/pgbouncer/releases/download/pgbouncer_1_11_0/pgbouncer-1.11.0.tar.gz \
  && tar zxf pgbouncer-1.11.0.tar.gz && rm pgbouncer-1.11.0.tar.gz \
  && cd /pgbouncer-1.11.0/ \
